...
fun IrrigateScreen() {
    ...
    val requiredWaterLiters = (et0 * kc * areaMultiplier * soilFactor * moistureDeficit).toInt().coerceAtLeast(0)
        ...
        Surface(
            ...
            Column(modifier = Modifier.padding(24.dp), horizontalAlignment = Alignment.CenterHorizontally) {
                ...
                Row(verticalAlignment = Alignment.Bottom) {
                    Text("$requiredWaterLiters", style = MaterialTheme.typography.displayLarge, color = MaterialTheme.colorScheme.onPrimaryContainer)
                ...
                Row(verticalAlignment = Alignment.CenterVertically) {
                    ...
                    Spacer(modifier = Modifier.width(8.dp))
                    Text(
                        "Based on $growthStage (Kc=${kc}), $soilTexture factor, ${100 - currentMoisture.toInt()}% deficit.",
